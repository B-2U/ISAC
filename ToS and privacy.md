...
[support]: https://discord.gg/nk7PSYrFWu 
[language]: https://discord.com/developers/docs/dispatch/field-values#predefined-field-values-accepted-locales

# Bot
This page covers the Terms of Service (Terms) and Privacy Policy of the Discord Bot **ISAC**
...
### Contact
People may get in contact hrough the official [Support Discord][support] of the Bot.  
...
- `ign` with user's ID and ign in World of Warships (WoWs) as value.  
- `default_region` with value `asia`
...
#### Manual removal
Manual removal of the data can be requested through email in [Support Discord][support].  
