...
[English](https://github.com/Fallen-Breath/MCDReforged/blob/master/README.md) | **中文** | [日本語](https://github.com/Fallen-Breath/MCDReforged/blob/master/README_ja.md)
...
| `.wws`           | `.wws [地區] <遊戲ID>`                        | `.wws asia B2U`<br>`.wws B2U`<br>`.wws me`                  | 顯示該玩家的總戰績 |
| `.wws ship`      | `.wws [地區] <遊戲ID> <船名> [戰鬥模式]`                 | `.wws asia B2U Ise`<br>`.wws B2U Yamato`<br>`.wws me Slava rank` | 顯示該玩家指定戰艦的戰績<br>`[戰鬥模式]`: `pvp` (預設), `solo`, `div2`, `div3`, `rank`          |
| `.recent`        | `.recent [地區] <遊戲ID> [戰鬥模式] [天數]` | `.recent asia B2U`<br>`.recent B2U 7`<br>`.recent me rank 21`     | 顯示該玩家最近X天的戰績<br>`[天數]`: `1`~`21` (預設: `1`)<br>`[戰鬥模式]`: `pvp` (預設), `solo`, `div2`, `div3`, `rank`                    |
...
| `.uid` | `.uid [region] <ign>` | `.uid me`<br>`.uid B2U`<br>`.uid asia B2U` | 顯示該玩家的 UID |
